...
export default function KontakPage() {
  return (
    <div className="py-12 md:py-20 bg-stone-50 min-h-screen">
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card className="border-stone-100 shadow-sm bg-white">
              <CardContent className="p-8 space-y-8">
                <div>
                  <h3 className="text-xl font-bold text-stone-900 mb-6 border-b border-stone-100 pb-4">Informasi Kontak</h3>
                  <ul className="space-y-6">
                    <li className="flex gap-4">
                      ...
                      <div>
                        <div className="font-semibold text-stone-900 mb-1">Alamat Sekolah</div>
                    ...
                    <li className="flex gap-4">
                      ...
                      <div>
                        <div className="font-semibold text-stone-900 mb-1">Telepon & WhatsApp</div>
                        <p className="text-stone-600 text-sm leading-relaxed">
                          +62 21 1234 5678<br />
                          +62 812 3456 7890 (WA)
                        </p>
                    ...
                    <li className="flex gap-4">
                      ...
                      <div>
                        <div className="font-semibold text-stone-900 mb-1">Jam Operasional</div>
                        <p className="text-stone-600 text-sm leading-relaxed">
          ...
          <div className="lg:col-span-2">
            <Card className="border-stone-100 shadow-sm bg-white h-full">
              <CardContent className="p-8 md:p-10">
                <h3 className="text-2xl font-bold text-stone-900 mb-2">Kirim Pesan</h3>
                <p className="text-stone-500 mb-8">Silakan isi formulir di bawah ini, tim kami akan membalas pesan Anda maksimal 1x24 jam.</p>
                
                <form className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="name">Nama Lengkap</Label>
                      <Input id="name" placeholder="Masukkan nama Anda" className="bg-stone-50 border-stone-200 h-12" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="phone">Nomor HP/WhatsApp</Label>
                      <Input id="phone" placeholder="Contoh: 08123456789" className="bg-stone-50 border-stone-200 h-12" />
                    </div>
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="email">Alamat Email</Label>
                    <Input id="email" type="email" placeholder="email@contoh.com" className="bg-stone-50 border-stone-200 h-12" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="subject">Subjek</Label>
                    <Input id="subject" placeholder="Topik pesan Anda" className="bg-stone-50 border-stone-200 h-12" />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      className="bg-stone-50 border-stone-200 min-h-[150px] resize-y"
                    />
                  </div>
                  <Button className="w-full md:w-auto px-8 h-12 bg-teal-600 hover:bg-teal-700 text-white rounded-full text-base">
          ...
          <Card className="border-stone-100 shadow-sm overflow-hidden">
            <div className="h-[400px] w-full bg-stone-200 relative">
              <div className="absolute inset-0 flex flex-col items-center justify-center text-stone-500">
                <MapPin className="h-12 w-12 mb-4 text-stone-400" />
