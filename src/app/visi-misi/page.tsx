    ...
    <div className="py-12 md:py-20 bg-white min-h-screen">
      <div className="container mx-auto px-4 md:px-6 max-w-5xl">
        ...
        <div className="space-y-16">
          {/* Visi */}
          <div className="relative bg-slate-50 rounded-3xl p-8 md:p-12 border border-slate-100 shadow-sm overflow-hidden">
            <div className="absolute top-0 right-0 -mr-8 -mt-8 opacity-5">
              <Target className="h-64 w-64 text-emerald-900" />
            </div>
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-6">
                <div className="h-12 w-12 rounded-xl bg-emerald-600 flex items-center justify-center text-white shrink-0">
                  <Target className="h-6 w-6" />
                </div>
                <h2 className="text-3xl font-bold text-slate-900">Visi Sekolah</h2>
              </div>
              <p className="text-2xl md:text-3xl font-medium text-emerald-800 leading-relaxed italic border-l-4 border-emerald-500 pl-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex gap-4">
                    ...
                    <p className="text-slate-700 leading-relaxed text-lg">{misi}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="bg-slate-900 rounded-3xl p-8 md:p-10 text-white shadow-xl relative overflow-hidden">
               ...
               <div className="relative z-10">
                <h2 className="text-3xl font-bold text-white mb-8 border-b border-slate-700 pb-4">Tujuan Lulusan</h2>
                <ul className="space-y-6">
                  <li className="flex flex-col gap-2">
                    <span className="font-semibold text-emerald-400 text-lg">1. Aqidah Kuat & Akhlak Mulia</span>
                    <span className="text-slate-300">Siswa memiliki keyakinan yang lurus dan mengaplikasikan adab islami dalam kehidupan sehari-hari.</span>
                  </li>
                  <li className="flex flex-col gap-2">
                    <span className="font-semibold text-emerald-400 text-lg">2. Hafal Juz 30</span>
                    <span className="text-slate-300">Target kelulusan adalah siswa mampu menghafal dengan lancar Juz 30 beserta tajwidnya.</span>
                  </li>
                  <li className="flex flex-col gap-2">
                    <span className="font-semibold text-emerald-400 text-lg">3. Berprestasi Akademik</span>
                    <span className="text-slate-300">Meraih nilai rata-rata ujian di atas standar nasional dan mampu bersaing masuk ke jenjang berikutnya yang favorit.</span>
                  </li>
                </ul>
              </div>
            </div>
