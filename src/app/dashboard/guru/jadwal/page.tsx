      ...
      <Card className="border-slate-100 shadow-sm bg-white overflow-hidden">
        <CardHeader className="bg-slate-50/50 border-b border-slate-100 pb-4">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-lg text-slate-900">Daftar Jadwal Mengajar</CardTitle>
          </div>
        </CardHeader>
                        ...
                        <TableCell key={dayIdx} className="border-r border-slate-100 last:border-0 p-3 align-top bg-white">
                          {session ? (
                            <div className="h-full flex flex-col">
                              ...
                              <div className="text-xs text-emerald-600 font-medium mt-1">Kelas {session.className}</div>
                            </div>
                          ) : (
