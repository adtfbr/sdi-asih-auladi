    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-stone-500">Lihat jadwal mata pelajaran kelas Anda untuk minggu ini.</p>
        </div>
      </div>
      ...
      <Card className="border-stone-100 shadow-sm bg-white overflow-hidden">
        <CardHeader className="bg-stone-50/50 border-b border-stone-100 pb-4">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-lg text-stone-900">Jadwal Kelas Aktif</CardTitle>
          </div>
        </CardHeader>
