      ...
      <Tabs defaultValue="general" className="w-full">
            ...
            <Card className="border-slate-100 shadow-sm">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input name="schoolName" id="schoolName" value={formDataState.schoolName} onChange={handleChange} className="bg-slate-50 border-slate-200" required />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="npsn">NPSN</Label>
                  <Input name="npsn" id="npsn" value={formDataState.npsn} onChange={handleChange} className="bg-slate-50 border-slate-200" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="address">Alamat Lengkap</Label>
                  <Input name="address" id="address" value={formDataState.address} onChange={handleChange} className="bg-slate-50 border-slate-200" required />
                </div>
        ...
        <TabsContent value="academic" className="mt-6">
          <Card className="border-slate-100 shadow-sm">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-slate-500">Silakan gunakan menu Tahun Ajaran untuk mengubah status aktif.</p>
            </CardContent>
          </Card>
        </TabsContent>
            ...
            <Card className="border-slate-100 shadow-sm">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <select name="ppdbStatus" id="ppdbStatus" value={formDataState.ppdbStatus} onChange={handleChange} className="flex h-10 w-full items-center justify-between rounded-md border border-slate-200 bg-slate-50 px-3 py-2 text-sm ring-offset-white focus:outline-none focus:ring-2 focus:ring-emerald-500">
                ...
                <div className="space-y-2">
                  ...
                  <Input name="ppdbWave" id="ppdbWave" value={formDataState.ppdbWave} onChange={handleChange} className="bg-slate-50 border-slate-200" />
                </div>
                <div className="pt-4 flex justify-end">
                  <Button type="submit" disabled={loading} className="bg-emerald-600 hover:bg-emerald-700 text-white">
